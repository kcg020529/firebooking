...
--  ⚠️ URL이 살아있다는 것과 내용이 맞다는 건 다르다. 8개 전부
--     브라우저로 열어서 실제로 골프장·스크린골프 사진인지 확인했다
--     (첫 시도에서 헬스장·침실·경기장 통로 사진이 섞여 나온 적 있음).
--
--  ⚠️ SQL Editor에 붙여넣은 뒤 한글이 깨져 보이면(예: "泹喃" 같은 한자 조합)
--     파일이 아니라 브라우저 클립보드 붙여넣기 단계에서 깨진 것이다.
--     이 SQL을 다시 붙여넣지 말고 scripts/fix-seed-encoding.py 를 돌린다 —
--     같은 파일을 API로 직접 읽어서 클립보드 없이 다시 써넣는다.
--
...
insert into public.courses (name, type, region, address, phone, image_url, description) values
  ...
  ('스카이스크린 강남점', 'screen', '서울', '서울특별시 강남구 테헤란로 501, 3층', '02-555-1001',
   'https://images.unsplash.com/photo-1704863619342-9cf73eca5fe8?w=800&q=80',
   '최신 시뮬레이터 8타석. 예약제로 운영해 대기 없이 이용 가능하다.'),

  ('버디존 스크린골프 홍대', 'screen', '서울', '서울특별시 마포구 홍익로 88, 2층', '02-555-1002',
   'https://images.unsplash.com/photo-1704863619926-ff5427e043aa?w=800&q=80',
   '홍대입구역 도보 3분. 24시간 운영, 심야 할인 타임 있음.'),

  ('그랜드스윙 판교점',   'screen', '경기', '경기도 성남시 분당구 판교역로 231', '031-555-1003',
   'https://images.unsplash.com/photo-1515358204547-8689c79d6991?w=800&q=80',
   '실내 6타석 프리미엄 매장. 개인 레슨 프로 상주.'),

  ('이글파크 스크린 수원점', 'screen', '경기', '경기도 수원시 영통구 광교로 15', '031-555-1004',
   'https://images.unsplash.com/photo-1763002487829-a177254d758e?w=800&q=80',
